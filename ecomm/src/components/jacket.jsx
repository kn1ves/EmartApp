...
var normal = require('../svg/jackets.svg');
var hover = require('../svg/jackets-hover.svg');
...
class JacketSvg extends React.Component {
...
export default withStyles(styles)(JacketSvg);