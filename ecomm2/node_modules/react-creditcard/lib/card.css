...
.react-credit-card__front,
.react-credit-card__back {
  background: linear-gradient(to right, #6290e4, #2053B1); }
...
.react-credit-card--mastercard .react-credit-card__back {
  background: linear-gradient(to right, #2fa7ff, #0061A8); }

.react-credit-card__logo.react-credit-card--mastercard {
  width: 50px; }
...
.react-credit-card--visa .react-credit-card__back {
  background: linear-gradient(to right, #2653d0, #191278); }

.react-credit-card__logo.react-credit-card--visa {
  width: 70px; }
