...
var normal = require('../svg/shoes.svg');
var hover = require('../svg/shoes-hover.svg');
...
class ShoeSvg extends React.Component {
  ...
  return (
    <div><Link to='/shoes' style={{textDecoration: 'none'}}>
...
export default withStyles(styles)(ShoeSvg);